...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var x, y, z;
        x = other1.elements[1]*other2.elements[2] - other1.elements[2]*other2.elements[1];
        y = other1.elements[2]*other2.elements[0] - other1.elements[0]*other2.elements[2];
        z = other1.elements[0]*other2.elements[1] - other1.elements[1]*other2.elements[0];
